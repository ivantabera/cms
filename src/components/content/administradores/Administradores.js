...
export default function Administradores(){
    ...
    const dataAdministradores = async() => {
        ...
        getAdministradores.data.forEach((currentValue, index)=>{
            
            dataSet[index] = [(index+1),
                                currentValue.usuario,
                                [currentValue._id, currentValue.usuario]];
        })
    ...
    /* Ejecutamos dataAdministradores */
    dataAdministradores();
    ...
    return(
        ...
        <div className="content-wrapper" style={{minHeight:"494px"}}>
                        ...
                        <div className="col-lg-12">
                            ...
                            <div className="card card-primary card-outline">
                                ...
                                <div className="card-header">
                                    <h5 className="m-0">
                                        <button className="btn btn-primary limpiarFormulario" data-toggle="modal" data-target="#crearAdmin">
            ...
            {/* Ventana modal para la edicion o borrar de datos */}
...
const getData = () => {
    ...
    const url = `${rutaAPI}/mostrar-administrador`;
