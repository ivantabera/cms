...
export default function Articulos(){
    ...
    const dataArticulo = async() => {
        ...
        getArticulos.data.forEach((currentValue, index)=>{

            dataSet[index] = 
                [
                    (index+1),
                    currentValue.url+'+'+currentValue.portada,
                    currentValue.url,
                    currentValue.titulo,
                    currentValue.intro,
                    ...
                    [   
                        currentValue._id+'_',
                        currentValue.portada+'_',
                        currentValue.titulo+'_',
                        currentValue.intro+'_',
                        currentValue.url+'_',
                        currentValue.contenido
                    ]
                ];
        ...
        $(document).ready( function () {
            let tablaArticulo = $('.table').DataTable({

                responsive: true,

                data: dataSet, 

                /* Ordernar por ultimo registrado */
                "columnDefs":[{
                    "searchable":true,
                    "orderable":true,
                    "targets":0
                ...
                "order":[[0,"desc"]],
                /* FIN Ordernar por ultimo registrado */
                ...
                columns: [
                    ...
                    {title: "Acciones",
                        render: function(data){
                            return `
                                <a href="" class="editarInputs" data-toggle="modal" data-target="#editarBorrarArticulo" data='${data}'>
             ...
             /* Acomodar los indices de manera ascendente cuando ordenemos la tabla por ultimo registrado  */
            tablaArticulo.on("order.dt search.dt", function(){

                tablaArticulo.column(0, {search:"applied", order:"applied"}).nodes().each(function(cell, i){
                    ...
                    <div className="row">
                        ...
                        <div className="col-lg-12">
                            ...
                            <div className="card-header">
                                    <h5 className="m-0">
                                        <button className="btn btn-primary limpiarFormulario" data-toggle="modal" data-target="#crearArticulo" >
...
const getData = () => {
    ...
    /* Ruta a la cual accederemos para mostrar la informacion del articulo */
